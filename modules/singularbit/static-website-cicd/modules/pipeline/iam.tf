...
resource "aws_iam_role" "codepipeline_role" {
  name = "${var.project_name}-${var.static_website_key}-cp-role"
...
resource "aws_iam_role_policy" "codepipeline_policy" {
  name = "${var.project_name}-${var.static_website_key}-cp-policy"
...
resource "aws_iam_role" "codebuild_role" {
  name = "${var.project_name}-${var.static_website_key}-cb-role"
...
resource "aws_iam_role_policy" "codebuild_policy" {
  name = "${var.project_name}-${var.static_website_key}-cb-policy"
